...
from .resources.memory_threads import memory_threads

__all__ = ["Timeout", "Transport", "ProxiesTypes", "RequestOptions", "Mastra", "AsyncMastra", "Client", "AsyncClient"]


class Mastra(SyncAPIClient):
    system: system.SystemResource
    agents: agents.AgentsResource
    memory: memory.MemoryResource
    memory_threads: memory_threads.MemoryThreadsResource
    workflows: workflows.WorkflowsResource
    syncs: syncs.SyncsResource
    logs: logs.LogsResource
    tools: tools.ToolsResource
    with_raw_response: MastraWithRawResponse
    with_streaming_response: MastraWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous mastra client instance."""
        if base_url is None:
            base_url = os.environ.get("MASTRA_BASE_URL")
        if base_url is None:
        ...
        self.memory_threads = memory_threads.MemoryThreadsResource(self)
        ...
        self.with_raw_response = MastraWithRawResponse(self)
        self.with_streaming_response = MastraWithStreamedResponse(self)
...
class AsyncMastra(AsyncAPIClient):
    system: system.AsyncSystemResource
    agents: agents.AsyncAgentsResource
    memory: memory.AsyncMemoryResource
    memory_threads: memory_threads.AsyncMemoryThreadsResource
    workflows: workflows.AsyncWorkflowsResource
    syncs: syncs.AsyncSyncsResource
    logs: logs.AsyncLogsResource
    tools: tools.AsyncToolsResource
    with_raw_response: AsyncMastraWithRawResponse
    with_streaming_response: AsyncMastraWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async mastra client instance."""
        if base_url is None:
            base_url = os.environ.get("MASTRA_BASE_URL")
        if base_url is None:
            base_url = f"http://localhost:4111"
        ...
        self.memory_threads = memory_threads.AsyncMemoryThreadsResource(self)
        ...
        self.with_raw_response = AsyncMastraWithRawResponse(self)
        self.with_streaming_response = AsyncMastraWithStreamedResponse(self)
...
class MastraWithRawResponse:
    def __init__(self, client: Mastra) -> None:
        ...
        self.memory_threads = memory_threads.MemoryThreadsResourceWithRawResponse(client.memory_threads)
...
class AsyncMastraWithRawResponse:
    def __init__(self, client: AsyncMastra) -> None:
        ...
        self.memory_threads = memory_threads.AsyncMemoryThreadsResourceWithRawResponse(client.memory_threads)
...
class MastraWithStreamedResponse:
    def __init__(self, client: Mastra) -> None:
        ...
        self.memory_threads = memory_threads.MemoryThreadsResourceWithStreamingResponse(client.memory_threads)
...
class AsyncMastraWithStreamedResponse:
    def __init__(self, client: AsyncMastra) -> None:
        ...
        self.memory_threads = memory_threads.AsyncMemoryThreadsResourceWithStreamingResponse(client.memory_threads)
