...
class TestSystem:
    ...
    @parametrize
    def test_method_retrieve_status(self, client: MastraClient) -> None:
        system = client.system.retrieve_status()
        assert system is None

    @parametrize
    def test_raw_response_retrieve_status(self, client: MastraClient) -> None:
    ...
    @parametrize
    def test_streaming_response_retrieve_status(self, client: MastraClient) -> None:
...
class TestAsyncSystem:
    ...
    @parametrize
    async def test_method_retrieve_status(self, async_client: AsyncMastraClient) -> None:
        system = await async_client.system.retrieve_status()
        assert system is None

    @parametrize
    async def test_raw_response_retrieve_status(self, async_client: AsyncMastraClient) -> None:
    ...
    @parametrize
    async def test_streaming_response_retrieve_status(self, async_client: AsyncMastraClient) -> None:
